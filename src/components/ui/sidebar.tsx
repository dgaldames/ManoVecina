...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ref={ref}
      data-sidebar="rail"
      aria-label="Ajustar barra lateral"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="Ajustar barra lateral"
      className={cn(
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2 dark:bg-gray-900 transition-all duration-200 ease-in-out", className)}
      {...props}
    />
  )
})
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden dark:bg-gray-900 transition-all duration-100 ease-in-out",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col p-2 dark:bg-gray-900 transition-all duration-200 ease-in-out", className)}
      {...props}
    />
  )
})
