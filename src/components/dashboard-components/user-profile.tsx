    ...
    return (
        <div className="relative w-full p-5 bg-white border border-gray-300 rounded-lg shadow dark:bg-gray-800 dark:border-gray-900">
            ...
            <div className="absolute flex top-3 right-5 dark:bg-gray-900 bg-gray-100 px-4 py-4 rounded-lg">
                <h3 className="font-medium dark:text-white xl:text-3xl lg:text-xl text-lg">Jardineria General</h3>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-5">
            ...
            <a
                href="#"
                className="inline-flex items-center justify-center px-10 py-6 text-3xl font-semibold text-center text-white bg-green-500 rounded-lg ring-1 hover:ring-darkbg dark:hover:ring-white hover:bg-green-600 focus:ring-2 focus:ring-darkbg dark:focus:ring-white focus:outline-none w-full lg:w-auto"
            >
                Contactar
