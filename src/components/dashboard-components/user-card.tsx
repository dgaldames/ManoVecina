...
export default function UserCard ({ userName, userService, userDetails }:{userName: string, userService: string, userDetails: string}) {
    return(
        <div className="w-full max-w-lg pt-10 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="flex flex-col items-center pb-8">
                <Image className="w-24 h-24 mb-3 rounded-full shadow-lg" 
                alt="Bonnie image" 
                src={"/dashboard-imgs/user-card/bonnie.jpg"}
                width={24}
                height={24}/>
