    ...
    return(
        <main className="mb-52 py-12 px-6">
            ...
            <div className="flex justify-center mt-14">
                <button className="rounded-2xl bg-vecino hover:bg-orange-600 hover:ease-out transition duration-300 transform hover:scale-105 md:px-8 px-5 md:py-6 py-3 md:text-2xl text-xl text-center text-white inline-flex items-center ">
